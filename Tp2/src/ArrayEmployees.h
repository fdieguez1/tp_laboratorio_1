#ifndef ARRAYEMPLOYEES_H_HEADER
#define ARRAYEMPLOYEES_H_HEADER
...
/** \brief Swaps positions of employees in array
 *
 * \param employeeA Employee*
 * \param employeeB Employee*
...
/** \brief print the calculations of employees salaries
 *
 * \param list Employee*
 * \param length int
 * \return int
...
/** \brief find the first empty employee and return his index
 *
 * \param list Employee*
 * \param length int
 * \return int (-1) not found (0-length) index in array
 */
